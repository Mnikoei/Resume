...
var EventController = {
    ...
    toggleShowProfile: function(e) {
        ...
        this.removeProfilePicTransitionClasses();
    ...
    showProfilePic: function() {
        ...
        if (!!profilePic && profilePic.classList.contains('profile-increase-scale')) {
            ...
            messageIcon.classList.add('message-icon-change-position-for-profile');
            nameStatus.classList.add('name-status-change-position-for-profile-pic');
        }

    },
    removeProfilePicTransitionClasses: function() {
        profileInfo.classList.remove('profile-info-change-position-for-profile-pic');
        profile.classList.remove('profile-increase-scale');
        messageIcon.classList.remove('message-icon-change-position-for-profile');
        nameStatus.classList.remove('name-status-change-position-for-profile-pic');
    }
